...
/****************/
	...
	tempVertex2D6.a = 0.25; tempVertex2D6.b = 0.75; // 0.25,0.75
	frontProjVertex.addVertex(tempVertex2D4);

	tempVertex2D7.a = 0.75; tempVertex2D7.b = 0.25; // 0.75,0.25
	frontProjVertex.addVertex(tempVertex2D4);
...
/****************/
	...
	// cout << "First LOOp:"<<"\n";
	// generalMethods::printEdgeList(tempBasicLoopEdgeSet.at(0).at(0).eList);cout<<"\n";
	// cout << "Second LOOp:"<<"\n";
	// generalMethods::printEdgeList(tempBasicLoopEdgeSet.at(1).at(0).eList);cout<<"\n";
	// int confi = generalMethods::checkConfinement(tempBasicLoopEdgeSet.at(0).at(0), tempBasicLoopEdgeSet.at(1).at(0));
	// cout << "Confi: " << confi;
